                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {filteredPosts.map((post, i) => (
                                <motion.article
                                    ...
                                    className="group flex flex-col bg-background border border-slate-100 rounded-3xl overflow-hidden hover:shadow-2xl hover:shadow-[#3b82f6]/5 hover:-translate-y-1 transition-all duration-500"
                                >
                                    {/* Image */}
                        ...
                        {["1", "2", "3", "→"].map((p, i) => (
                            <button
                                ...
                                className={`w-11 h-11 rounded-xl border text-sm font-black transition-all ${p === "1"
                                        ...
                                        : "bg-white border-slate-200 text-slate-400 hover:border-[#3b82f6] hover:text-[#3b82f6]"
                                    }`}
                            >
                                {p}
                            </button>
                    ...
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                            <input
                                ...
                                className="flex-1 h-12 rounded-xl px-5 bg-white/5 border border-white/10 text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[#3b82f6]/40 font-medium text-sm"
                            />
                            <button className="h-12 px-7 bg-[#3b82f6] text-white font-black text-sm rounded-xl hover:bg-[#4551FF] transition-colors shrink-0">
                                Subscribe →
                            </button>
                        </div>
