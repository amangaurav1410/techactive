    ...
    return (
        <div className="min-h-screen">
            <PageHero
                ...
                title={<>Command the <br /><span className="text-[#2F3BFF]">Search Landscape.</span></>}
            ...
            <section className="py-28 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16 max-w-2xl mx-auto">
                        <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#2F3BFF] mb-3">Our SEO Services</p>
                        <h2 className="text-3xl md:text-5xl font-black text-[#0b0f2f] mb-4">Strategic Search Dominance.</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {seoServices.map((s, i) => (
                            <div key={i} className="group p-10 bg-[#F5F7FB] border border-slate-100/50 rounded-3xl hover:bg-white hover:shadow-2xl hover:shadow-[#2F3BFF]/5 transition-all duration-500">
                                ...
                                <h4 className="text-xl font-bold text-[#0b0f2f] group-hover:text-[#2F3BFF] transition-colors mb-3">{s.title}</h4>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="space-y-8">
                            <div>
                                <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#2F3BFF] mb-3">Proven Results</p>
                                <h2 className="text-3xl md:text-5xl font-black text-[#0b0f2f] mb-6">Measurable Ranking Improvements.</h2>
                            ...
                            <ul className="space-y-5">
                                {results.map((item, i) => (
                                    <li key={i} className="flex items-center gap-4 text-[#0b0f2f] font-bold text-lg">
                                        <TrendingUp className="w-6 h-6 text-[#2F3BFF] shrink-0" />
                                        {item}
                                    </li>
                                ))}
                            </ul>
                        ...
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/3]">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-tl from-[#0b0f2f]/40 to-transparent" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-white border-t border-slate-100">
                <div className="container mx-auto px-6">
                    <div className="max-w-3xl mx-auto">
                        <div className="bg-[#F5F7FB] rounded-3xl p-10 border border-slate-100">
                            <p className="text-xs font-bold uppercase tracking-widest text-[#2F3BFF] mb-6">12-Month Growth</p>
                            <div className="flex items-end gap-2 h-48">
                                {[20, 35, 30, 55, 50, 85, 80, 95, 88, 100, 98, 110].map((h, i) => (
                                    <motion.div
                                        ...
                                        className="flex-1 bg-[#2F3BFF]/20 hover:bg-[#2F3BFF] transition-colors rounded-t-lg"
                                    />
                                ))}
                            </div>
