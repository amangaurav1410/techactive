    ...
    return (
        <div className="min-h-screen">
            <PageHero
                ...
                title={<>Data-Driven <br /><span className="text-[#1b18ff]">Marketing Velocity.</span></>}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {caseStudyStats.map((s, i) => (
                            <div key={i} className="text-center group">
                                <div className="text-5xl md:text-7xl font-black text-[#1b18ff] group-hover:scale-110 transition-transform mb-3 tracking-tighter">{s.value}</div>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            <div>
                                <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#1b18ff] mb-3">Performance-First</p>
                                <h2 className="text-3xl md:text-5xl font-black text-[#050918] mb-6">Results You Can Measure.</h2>
                            ...
                            <div className="space-y-4">
                                {["Google & Meta Ads", "Email & SMS Campaigns", "Influencer Partnerships", "Retargeting Funnels"].map((item) => (
                                    <div key={item} className="flex items-center gap-3">
                                        <div className="w-2 h-2 rounded-full bg-[#1b18ff]" />
                        ...
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
                            ...
                            <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-md rounded-2xl p-4 flex items-center gap-4 shadow-xl">
                                <div className="w-10 h-10 bg-[#1b18ff] rounded-xl flex items-center justify-center">
                                    <TrendingUp className="w-5 h-5 text-white" />
                                </div>
                                <div>
                                    <p className="text-[9px] font-black uppercase tracking-widest text-slate-400">ROI Increase</p>
                                    <p className="text-xl font-black text-[#050918]">+295%</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-28 bg-background">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16 max-w-2xl mx-auto">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black text-[#050918] mb-4">Full-Service Digital Ecosystem.</h2>
                ...
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-10 text-left">
                        {[
                            ...
                            <div key={i} className="space-y-4 border-l-2 border-[#1b18ff]/30 pl-8 relative">
                                <div className="absolute -left-[9px] top-0 w-4 h-4 bg-[#1b18ff] rounded-full shadow-lg shadow-[#1b18ff]/50" />
                                <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">Step 0{i + 1}</span>
                                <h4 className="text-2xl font-black text-[#1b18ff]">{step.title}</h4>
