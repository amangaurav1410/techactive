    ...
    return (
        <div className="min-h-screen">
            <PageHero
                ...
                title={<>Data-Driven <br /><span className="text-[#3b82f6]">Marketing Velocity.</span></>}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {caseStudyStats.map((s, i) => (
                            <div key={i} className="text-center group">
                                <div className="text-5xl md:text-7xl font-black text-[#3b82f6] group-hover:scale-110 transition-transform mb-3 tracking-tighter">{s.value}</div>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            <div>
                                <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#3b82f6] mb-3">Performance-First</p>
                ...
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-10 text-left">
                        {[
                            ...
                            <div key={i} className="space-y-4 border-l-2 border-[#3b82f6]/30 pl-8 relative">
                                <div className="absolute -left-[9px] top-0 w-4 h-4 bg-[#3b82f6] rounded-full shadow-lg shadow-[#3b82f6]/50" />
                                <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">Step 0{i + 1}</span>
                                <h4 className="text-2xl font-black text-[#3b82f6]">{step.title}</h4>
