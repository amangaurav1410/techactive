        ...
        <section className="py-40 bg-background overflow-hidden relative">
            <div className="container mx-auto px-6">
                <div className="relative">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[#1b18ff]/5 rounded-[10rem] rotate-12 -z-10" />
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-20">
                        ...
                        <div className="lg:w-1/2 space-y-10">
                            ...
                            >
                                <Sparkles className="w-8 h-8 text-[#1b18ff]" />
                                <span className="text-xs font-black tracking-[0.4em] text-[#1b18ff] uppercase">Ready to scale?</span>
                            </motion.div>
                            ...
                            >
                                YOUR JOURNEY <br /> <span className="text-[#1b18ff]">STARTS HERE.</span>
                            </motion.h2>
                            ...
                            <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                                {guarantees.map((g, i) => (
                                    <div key={i} className="flex items-center gap-3">
                                        <CheckCircle className="w-5 h-5 text-[#1b18ff]" />
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 pt-6">
                                <Link href="/contact">
                                    <GradientButton className="h-16 px-10 text-sm font-black tracking-widest uppercase rounded-2xl shadow-2xl shadow-[#1b18ff]/40">
                                        Book Free Consultation
                                    </GradientButton>
                                </Link>
                                <Link href="/services" className="inline-flex items-center justify-center gap-2 h-16 px-10 text-sm font-bold text-[#050918] hover:text-[#1b18ff] transition-all">
